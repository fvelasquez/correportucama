...
j(function(){
	...
	<?php
		for($i = 1;$i<=34;$i++){
			echo "
			j('#corredor_".$i."').sprite({fps: 30, no_of_frames: 4});
			";
		}
	?>
...
<div id="appbody">
	...
	<div id="appanuncios">
	El d&iacute;a 20 de mayo se corrio la &uacute;ltima carrera por tu pasaporte.
	<br />
	Gracias a todos por participar!<br /><br />
	Puedes comprar tus entradas para Ensancha 2011 ingresando a <br /> <a href="top.location = 'http://ensancha.org'">Ensancha.org</a>
	</div>
	<?php 
